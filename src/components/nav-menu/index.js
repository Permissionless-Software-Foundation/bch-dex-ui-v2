      ...
      <Navbar collapseOnSelect expand='xxxl' bg='dark' variant='dark' style={{ paddingRight: '20px' }}>
        ...
        <Navbar.Collapse id='responsive-navbar-nav' style={{ paddingLeft: '20px' }}>
          <Nav className='mr-auto'>
            <Nav.Link href='#' onClick={(e) => handleClickEvent(0)}>NFTs</Nav.Link>
            <Nav.Link href='#' onClick={(e) => handleClickEvent(1)}>Fungible Tokens</Nav.Link>
            <Nav.Link href='#' onClick={(e) => handleClickEvent(2)}>BCH</Nav.Link>
            <Nav.Link href='#' onClick={(e) => handleClickEvent(3)}>Tokens</Nav.Link>
            <Nav.Link href='#' onClick={(e) => handleClickEvent(4)}>Wallet</Nav.Link>
            <Nav.Link href='#' onClick={(e) => handleClickEvent(5)}>Sweep</Nav.Link>
            <Nav.Link href='#' onClick={(e) => handleClickEvent(6)}>Sign</Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Navbar>
    </>
